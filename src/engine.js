...
// Reklam kancası (src/ads.js — en son yüklenir). Sadece native'de iş yapar;
// tarayıcıda fonksiyon varsa bile sayaç tutar, reklam göstermez.
if(typeof adsOnDayTransition==='function')adsOnDayTransition();
}
